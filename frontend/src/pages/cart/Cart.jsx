                                    ...
                                    <div className="row g-0">
                                                ...
                                                {cart.map((item) => (
                                                    <div className="row mb-4 d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div className="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                                            <h6 className="mb-0">NPR. {item.price * item.quantity}</h6>
                                                        </div>
                                                        <div className="col-md-1 col-lg-1 col-xl-1 text-end">
                                                            <button href="#!" className="text-muted">
                                                                <i className="fas fa-times" onClick={() => handleRemoveItem(item.id)}></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                                ))}
                                        ...
                                        <div className="col-lg-4 bg-grey">
                                            <div className="p-5">
                                                ...
                                                <button className="btn btn-primary btn-lg btn-block mt-3" onClick={handleCreateOrder}>
                                                    Place an order
                                                </button>
                                            </div>
                                        </div>
